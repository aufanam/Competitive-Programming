...
void solve() {
        ...
        set<char> zx = {'1', '3', '4', '6', '8', '9'};
        set<char> cs = {'1', '2', '3', '4', '6', '7', '8', '9'};
        int cntu, cntx;
        cntu = cntx = 0;
        for (int i = 0; i < n; i++) {
                if (s[i] == '_') cntu++;
        ...
        if (s[n-2] == '0') {
                ...
                if (fd == '0') {
                        int res = 1;
                        if (s[0] != 'X' && cntx > 0) res *= 10;
                        if (s[0] == 'X' && cntx > 0) res *= 9;
                        if (s[0] != '_') res *= pow(10, cntu);
                        if (s[0] == '_') res *= pow(10, cntu - 1)*9;
                        cout << res << '\n';
                } else if (fd == '_') {
                        int res = 1;
                        if (s[0] != 'X' && cntx > 0) res *= 10;
                        if (s[0] == 'X' && cntx > 0) res *= 9;
                        if (s[0] != '_') res *= pow(10, cntu - 1);
                        if (s[0] == '_') res *= pow(10, cntu - 2)*9;
                        cout << res << '\n';
                } else if (fd == 'X') {
                        int res = 1;
                        if (s[0] != 'X' && cntx > 0) res *= 1;
                        if (s[0] == 'X' && cntx > 0) res *= 0;
                        if (s[0] != '_') res *= pow(10, cntu);
                        if (s[0] == '_') res *= pow(10, cntu - 1)*9;
                        cout << res << '\n';
                }
                ...
                if (fd == '0') {
                        int ans = 0;
                        {
                                ...
                                if (s[0] == 'X' && cntx > 0) res *= 9;
                                if (s[0] != '_') res *= pow(10, cntu - 1);
                                if (s[0] == '_' && n != 2) res *= pow(10, cntu - 2)*9;
                                if (n == 2) res *= 0;
                                ans += res;
                        }
                        {
                        ...
                        if (s[0] != 'X' && cntx > 0) res *= 10;
                        if (s[0] == 'X' && cntx > 0) res *= 9;
                        if (s[0] != '_') res *= pow(10, cntu - 2);
                        if (s[0] == '_' && n != 2) res *= pow(10, cntu - 3)*9;
                        if (n == 2) res *= 3, res /= 4;
                        cout << res << '\n';
                } else if (fd == 'X') {
                        int ans = 0;
