...
//                         // cerr << zz[1].fi << ' ' << zz[1].se << '\n';
//                         // cerr << zz[2].fi << ' ' << zz[2].se << '\n';
//                         // cerr << zz[3].fi << ' ' << zz[3].se << '\n';
//                         // cerr << zz[4].fi << ' ' << zz[4].se << '\n';
//                         // cerr << bruh.back().fi.fi << ' ' << bruh.back().fi.se << ' ' << bruh.back().se << '\n';
//                 }
//                 return;
//         }
...
//                                         sum++;
//                                 } else if (bruh.size() >= 2) {
//                                         for (int ki = 0; ki < bruh.size(); ki++) {
//                                                 for (int kj = ki + 1; kj < bruh.size(); kj++) {
//                                                         set<pair<int, int>> buset;
//                                                         pair<int, int> a = bruh[ki].fi;
//                                                         pair<int, int> b = bruh[kj].fi;
//                                                         if (bruh[ki].se == 1) {
//                                                                 buset.insert({a.fi, a.se});
//                                                                 buset.insert({a.fi, a.se - 1});
//                                                                 buset.insert({a.fi, a.se + 1});
//                                                                 buset.insert({a.fi + 1, a.se});
//                                                         } else if (bruh[ki].se == 2) {
//                                                                 buset.insert({a.fi, a.se});
//                                                                 buset.insert({a.fi - 1, a.se});
//                                                                 buset.insert({a.fi + 1, a.se});
//                                                                 buset.insert({a.fi, a.se - 1});
//                                                         } else if (bruh[ki].se == 3) {
//                                                                 buset.insert({a.fi, a.se});
//                                                                 buset.insert({a.fi, a.se - 1});
//                                                                 buset.insert({a.fi, a.se + 1});
//                                                                 buset.insert({a.fi - 1, a.se});
...
//                                                         }
//                                                         if (bruh[kj].se == 1) {
//                                                                 buset.insert({b.fi, b.se});
//                                                                 buset.insert({b.fi, b.se - 1});
//                                                                 buset.insert({b.fi, b.se + 1});
//                                                                 buset.insert({b.fi + 1, b.se});
//                                                         } else if (bruh[kj].se == 2) {
//                                                                 buset.insert({b.fi, b.se});
//                                                                 buset.insert({b.fi - 1, b.se});
//                                                                 buset.insert({b.fi + 1, b.se});
//                                                                 buset.insert({b.fi, b.se - 1});
//                                                         } else if (bruh[kj].se == 3) {
//                                                                 buset.insert({b.fi, b.se});
//                                                                 buset.insert({b.fi, b.se - 1});
//                                                                 buset.insert({b.fi, b.se + 1});
//                                                                 buset.insert({b.fi - 1, b.se});
...
//                                                         if (buset.size() == 8) {
//                                                                 sum += 2;
//                                                                 best.push_back(bruh[ki]);
//                                                                 best.push_back(bruh[kj]);
//                                                                 ans.push_back(best);
//                                                                 goto Next;
//                                                         }
//                                                 }
