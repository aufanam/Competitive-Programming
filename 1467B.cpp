...
void solve() {
        ...
        {
                int res = zx;
                if ((v[1] > v[0] && v[1] > v[2]) || (v[1] < v[0] && v[1] < v[2])) res--;
                ckmin(ans, res);
        }
        {
                int res = zx;
                if ((v[n-2] > v[n-3] && v[n-2] > v[n-1]) || (v[n-2] < v[n-3] && v[n-2] < v[n-1])) res--;
                ckmin(ans, res);
        }
        for (int i = 1; i < n - 1; i++) {
                int x = v[i-1];
                ...
                if (i > 1 && i < n - 2) {
                        ...
                        int ky = v[i+2];
                        {
                                int res = zx;
                                int fd = x;
                                if ((x < kx && x < v[i]) || (x > kx && x > v[i])) res--;
                                if (((y < ky && y < v[i]) || (y > ky && y > v[i])) && !((y > ky && y > fd) || (y < ky && y < fd))) res--;
                                if (((v[i] < x && v[i] < y) || (v[i] > x && v[i] > y)) && !((fd < x && fd < y) || (fd > x && fd > y))) res--;
                                ckmin(ans, res);
                        }
                        {
                                int res = zx;
                                int fd = y;
                                if ((y < ky && y < v[i]) || (y > ky && y > v[i])) res--;
                                if (((x < kx && x < v[i]) || (x > kx && x > v[i])) && !((x > kx && x > fd) || (x < kx && x < fd))) res--;
                                if (((v[i] < x && v[i] < y) || (v[i] > x && v[i] > y)) && !((fd < x && fd < y) || (fd > x && fd > y))) res--;
                                ckmin(ans, res);
                        }
                } else if (i > 1) {
