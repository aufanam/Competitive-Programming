...
vector<pair<int, int>> dist(222222, {INFF, INFF});
int dijkstra(int st, int en) {
        ...
        while (!pq.empty()) {
                ...
                pq.pop();
                if (p.se.se == 0) {
                        if (p.fi > dist[p.se.fi].fi) continue;
                } else {
                        if (p.fi > dist[p.se.fi].se) continue;
                }
                for (auto z : v[p.se.fi]) {
                        if (p.se.se == 0) {
                                if (p.fi + z.se < dist[z.fi].fi) {
                                        dist[z.fi].fi = p.fi + z.se;
                                        pq.push({dist[z.fi].fi, {z.fi, 0}});
                                }
                                if (p.fi + z.se/2 < dist[z.fi].se) {
                                        dist[z.fi].se = p.fi + z.se/2;
                                        pq.push({dist[z.fi].se, {z.fi, 1}});
                                }
                        } else {
                                if (p.fi + z.se < dist[z.fi].se) {
                                        dist[z.fi].se = p.fi + z.se;
                                        pq.push({dist[z.fi].se, {z.fi, 1}});
                                }
                        }
                }
