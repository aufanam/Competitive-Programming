...
void solve() {
        ...
        vector<vector<char>> mv(n+5, vector<char>(m+5));
        ...
        while (!pq.empty()) {
                ...
                pq.pop();
                for (int k = 0; k < 4; k++) {
                        if (range(1, p.se.fi + dx[k], n) && range(1, p.se.se + dy[k], m) && v[p.se.fi + dx[k]][p.se.se + dy[k]] == '.' && !vis[p.se.fi + dx[k]][p.se.se + dy[k]]) {
                                pq.push({p.fi + 1, {p.se.fi + dx[k], p.se.se + dy[k]}});
                                mv[p.se.fi + dx[k]][p.se.se + dy[k]] = move[k];
                                vis[p.se.fi + dx[k]][p.se.se + dy[k]] = true;
                        }
                }
        }
        if (vis[xb][yb]) {
                ...
                string s = "";
                while (true) {
                        s.push_back(mv[xb][yb]);
                        if (mv[xb][yb] == 'U') xb++;
                        else if (mv[xb][yb] == 'D') xb--;
                        else if (mv[xb][yb] == 'L') yb++;
                        else if (mv[xb][yb] == 'R') yb--;
