...
void solve() {
        int n, m;
        cin >> n >> m;
        vector<vector<char>> v(n+5, vector<char>(m+5, 'a'));
        int cnt = 0;
        for (int i = 1; i <= n; i++) {
                for (int j = 1; j <= m; j++) {
                        cin >> v[i][j];
        ...
        for (int i = 1; i <= n - 1; i++) {
                for (int j = 1; j <= m - 1; j++) {
                        int z = (v[i][j] == '*') + (v[i+1][j] == '*') + (v[i][j+1] == '*') + (v[i+1][j+1] == '*');
                        if (z == 3) {
                                bool bull = false;
                                if (v[i][j] == '*') {
                                        if (v[i-1][j] == '*') bull = true;
                                        if (v[i][j-1] == '*') bull = true;
                                        if (v[i-1][j-1] == '*') bull = true;
                                        if (v[i+1][j-1] == '*') bull = true;
                                        if (v[i-1][j+1] == '*') bull = true;
                                }
                                if (v[i+1][j] == '*') {
                                        if (v[i][j-1] == '*') bull = true;
                                        if (v[i+1][j-1] == '*') bull = true;
                                        if (v[i+2][j-1] == '*') bull = true;
                                        if (v[i+2][j] == '*') bull = true;
                                        if (v[i+2][j+1] == '*') bull = true;
                                }
                                if (v[i][j+1] == '*') {
                                        if (v[i-1][j] == '*') bull = true;
                                        if (v[i-1][j+1] == '*') bull = true;
                                        if (v[i-1][j+2] == '*') bull = true;
                                        if (v[i][j+2] == '*') bull = true;
                                        if (v[i+1][j+2] == '*') bull = true;
                                }
                                if (v[i+1][j+1] == '*') {
                                        if (v[i][j+2] == '*') bull = true;
                                        if (v[i+1][j+2] == '*') bull = true;
                                        if (v[i+2][j+2] == '*') bull = true;
                                        if (v[i+2][j+1] == '*') bull = true;
                                        if (v[i+2][j] == '*') bull = true;
                                }
                                if (bull) {
                                ...
                                if (v[i+1][j] == '*') vis[i+1][j] = true;
                                if (v[i][j+1] == '*') vis[i][j+1] = true;
                                if (v[i+1][j+1] == '*') vis[i+1][j+1] = true;
                        }
                }
        }
        for (int i = 1; i <= n; i++) {
