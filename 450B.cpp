...
int main()
{
    ...
    ll d = c - b;
    ll a = n%6;
    if (a == 1) cout << (x+2*MOD)%MOD << '\n';
    else if (a == 2) cout << (y+2*MOD)%MOD << '\n';
    else if (a == 3) cout << (z+2*MOD)%MOD << '\n';
    else if (a == 4) cout << (b+2*MOD)%MOD << '\n';
    else if (a == 5) cout << (c+2*MOD)%MOD << '\n';
    else if (a == 0) cout << (d+2*MOD)%MOD << '\n';
    // code
    return 0;
}