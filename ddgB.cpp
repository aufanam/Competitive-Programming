...
int solve() {
        int a, b, c, d, e, f, g, h;
        cin >> a >> b >> c >> d >> e >> f >> g >> h;
        struct Point p1 = {a, b}, p2 = {a, d}, p3 = {c, b}, p4 = {c, d};
        struct Point q1 = {e, f}, q2 = {g, h};
        if (doIntersect(p1, p2, q1, q2)) return cout << "YA\n", 0;
        if (doIntersect(p1, p3, q1, q2)) return cout << "YA\n", 0;
        if (doIntersect(p2, p4, q1, q2)) return cout << "YA\n", 0;
        if (doIntersect(p3, p4, q1, q2)) return cout << "YA\n", 0;
        cout << "TIDAK\n";
        return 0;
}
