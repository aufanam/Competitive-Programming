...
void solve() {
    ...
    ll pow264 = -1, pow263 = -1, pow262 = -1, pow261 = -1, pow260 = -1;
    if (idx > 1) {
        string w = s.substr(1, idx - 1);
        ...
        string bruh = "";
        if (pow264 >= 0) {
            bruh += letter(pow264 + 26);
        } if (pow263 >= 0) {
            bruh += letter(pow263 + 26);
        } if (pow262 >= 0) {
            bruh += letter(pow262 + 26);
        } if (pow261 >= 0) {
            bruh += letter(pow261 + 26);
        } if (pow260 >= 0) {
            bruh += letter(pow260 + 26);
        }
        string ans = "";
        ans += bruh;
        ans += w;
